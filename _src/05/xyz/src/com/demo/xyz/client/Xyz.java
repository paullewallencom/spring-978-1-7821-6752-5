...
import com.demo.xyz.shared.FieldVerifier;
...
public class Xyz implements EntryPoint {
	...
	private final PacktAuthenticatorServiceAsync packtAuthenticatorService = GWT
			.create(PacktAuthenticatorService.class);
	/**
